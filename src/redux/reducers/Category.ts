...
const getCatesReducer = (state = initialState, action: any) => {
    switch(action.type){
...
const addCatesReducer = (state = initialStateAdd, action: any) => {
    switch(action.type){
...
const removeCatesReducer = (state = initialStateAdd, action: any) => {
    switch(action.type){
...
export {getCatesReducer, addCatesReducer, removeCatesReducer, updateFoodsReducer};